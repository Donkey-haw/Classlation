  ...
  return <div className="app-shell">
    ...
    <main className="game-layout">
      ...
      <section className="stage" data-testid={`phase-${phase}`}>
        {phase === "initial" && <div className="empty-state"><img className="stage-compass" src="/assets/guide-compass.png" alt="" /><span className="stage-kicker">숲속 몸짓 광장</span><h1>두 팀의 주제를 뽑아 주세요</h1><p>두 주제가 화면에 동시에 공개됩니다. 각 팀은 자기 주제를 확인해요.</p><div className="selected-summary"><strong>선택한 주제 {topics.length}개</strong><span>{selectedCategories.join(" · ")}</span></div></div>}
        ...
        {phase === "empty" && <div className="empty-state"><span className="stage-icon complete">✓</span><span className="stage-kicker">오늘의 탐험 완료</span><h1>준비한 주제를 모두 사용했어요</h1><p>처음부터 다시 하거나 주제 목록을 바꿀 수 있어요.</p><button className="button primary" onClick={() => resetGame()}>같은 주제로 다시 시작</button></div>}
      </section>
